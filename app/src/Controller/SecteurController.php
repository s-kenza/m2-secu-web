...
class SecteurController extends AbstractController
{
    ...
    {
        return $this->render('adminUser/secteur/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('adminUser/secteur/new.html.twig', [
            'secteur' => $secteur,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('adminUser/secteur/show.html.twig', [
            'secteur' => $secteur,
        ]);
    }
    ...
    public function edit(Request $request, Secteur $secteur, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('adminUser/secteur/edit.html.twig', [
            'secteur' => $secteur,
            'form' => $form,
        ]);
    }
