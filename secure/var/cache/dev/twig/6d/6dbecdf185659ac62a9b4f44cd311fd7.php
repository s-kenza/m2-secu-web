...
/* adminUser/metier/_form.html.twig */
class __TwigTemplate_2126dbcf89a77750b30a8bcd3f143d48 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "adminUser/metier/_form.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "adminUser/metier/_form.html.twig"));
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
            ...
            ";
                // line 6
                if (twig_matches("/competence|activite/", twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["field"], "vars", [], "any", false, false, false, 6), "full_name", [], "any", false, false, false, 6))) {
                    // line 7
                    echo "                <div class=\"mt-2\">
                    ";
                    // line 8
...
<div class=\"inline-flex justify-end space-x-2 mt-8 w-full\">
    ...
    ";
        ...
        if ((isset($context["deleteBtn"]) || array_key_exists("deleteBtn", $context) ? $context["deleteBtn"] : (function () { throw new RuntimeError('Variable "deleteBtn" does not exist.', 29, $this->source); })())) {
            // line 30
            echo "        <a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_metier_delete", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["metier"]) || array_key_exists("metier", $context) ? $context["metier"] : (function () { throw new RuntimeError('Variable "metier" does not exist.', 30, $this->source); })()), "id", [], "any", false, false, false, 30)]), "html", null, true);
...
";
    ...
    {
        return "adminUser/metier/_form.html.twig";
    }
...
{% for field in form %}
    {% if field.vars.name != '_token' %}
        <div class=\"mb-4\">
            {{ form_label(field) }}
            {% if field.vars.full_name matches '/competence|activite/' %}
                <div class=\"mt-2\">
                    {% for child in field %}
...
<div class=\"inline-flex justify-end space-x-2 mt-8 w-full\">
    ...
    {% if deleteBtn %}
        <a href=\"{{ path('app_metier_delete', {'id': metier.id}) }}\" onclick=\"return confirm('Are you sure you want to delete this item?');\" class=\"inline-block bg-red-500 hover:bg-red-700 text-white py-2 px-4 rounded\">
            Delete {#<i class=\"fa-solid fa-trash fa-xl\"></i>#}
        </a>
    {% endif %}
</div>
{{ form_end(form) }}
", "adminUser/metier/_form.html.twig", "/var/www/app/templates/adminUser/metier/_form.html.twig");
    }
}
