...
/* adminUser/secteur/_form.html.twig */
class __TwigTemplate_2be0c48b68b3b9ca02b4040c2d4da974 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "adminUser/secteur/_form.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "adminUser/secteur/_form.html.twig"));
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
            ...
            ";
                // line 6
                echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($context["field"], 'widget', ["attr" => ["class" => "shadow border rounded min-w-full mr-2 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"]]);
                echo "
            ";
                // line 7
    ...
    ";
        ...
        if ((isset($context["deleteBtn"]) || array_key_exists("deleteBtn", $context) ? $context["deleteBtn"] : (function () { throw new RuntimeError('Variable "deleteBtn" does not exist.', 17, $this->source); })())) {
            // line 18
            echo "            <a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_secteur_delete", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["secteur"]) || array_key_exists("secteur", $context) ? $context["secteur"] : (function () { throw new RuntimeError('Variable "secteur" does not exist.', 18, $this->source); })()), "id", [], "any", false, false, false, 18)]), "html", null, true);
...
";
    ...
    {
        return "adminUser/secteur/_form.html.twig";
    }
    ...
    {
        return array (  101 => 22,  97 => 20,  92 => 18,  90 => 17,  87 => 16,  83 => 13,  76 => 11,  72 => 10,  66 => 7,  62 => 6,  58 => 5,  55 => 4,  51 => 3,  47 => 2,  43 => 1,);
    }
...
{% for field in form %}
    {% if field.vars.name != '_token' %} {# Ne pas afficher le champ Token #}
        <div class=\"mb-4 mr-8 pb-2\">
            {{ form_label(field) }}
            {{ form_widget(field, {'attr': {'class': 'shadow border rounded min-w-full mr-2 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline'}}) }}
            {{ form_errors(field) }}
        </div>
    {% else %}
...
{% endfor %}
    <div class=\"inline-flex justify-end space-x-2 mt-8 w-full\">
        ...
        {% if deleteBtn %}
            <a href=\"{{ path('app_secteur_delete', {'id': secteur.id}) }}\" onclick=\"return confirm('Are you sure you want to delete this item?');\" class=\"inline-block bg-red-500 hover:bg-red-700 text-white py-2 px-4 rounded\">
                Delete {#<i class=\"fa-solid fa-trash fa-xl\"></i>#}
            </a>
        {% endif %}
{{ form_end(form) }}
", "adminUser/secteur/_form.html.twig", "/var/www/app/templates/adminUser/secteur/_form.html.twig");
    }
}
